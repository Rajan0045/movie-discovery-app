...
export default class Validation extends React.Component {
    constructor(props) {
        ...
        this.messages = {
            ...
            password: "Password requirements: min 6 characters long. At least one uppercase, one lowercase and one number",
            username:
            ...
            // email_exist: "The email you entered is already regstered with us."
        };
    }
        ...
        if (rule.length > 0) {
            switch (rule[0]) {
                ...
                case "maplink":
                    ...
                    // if (value && !/^https?\:\/\/(www\.)?google\.(com|fr|de)\/maps\b/.test(value)) {
                ...
                case "password":
                    ...
                    */
                    ...
                    if (value && !/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[A-Za-z\d@$!%*#?&_-]{6,}$/.test(value)) {
                        error = {
                            isValid: false,
                            message: this.messages[rule[0]],
                        };
